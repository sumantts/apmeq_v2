...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="RBER Soft Link">
  ...
  <body>
        ...
        <div class="contact__wrapper shadow-lg mt-n9">
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 contact-form__wrapper p-5 order-lg-1">
                    <h4 class="text-center">RBER Info</h4>
                    <form action="#" method="POST" class="contact-form form-validate" id="myForm">
                        ...
                        <div class="row">        
                            <div class="col-sm-6 mb-1">
                                <div class="form-group">
                                    <label for="rber_status">RBER status</label>
                                    <input type="text" class="form-control" id="rber_status" name="rber_status" >
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 mb-1">
                            <input type="hidden" name="rber_info_id" id="rber_info_id" value="<?=$_GET['rber_info_id']?>">
    ...
    <script>
        $('#myForm').on('submit', function(){
            ...
            $.ajax({
                ...
                data: { fn: "updateGeneratedFormdata", rber_info_id: $rber_info_id, facility_id: $facility_id, facility_code: $facility_code, department_id: $department_id, device_group: $device_group, asset_class: $asset_class, equipment_name: $equipment_name, equipment_make_model: $equipment_make_model, equipment_sl_no: $equipment_sl_no, pms_due_date: $pms_due_date, supplied_by: $supplied_by, service_provider_details: $service_provider_details, pms_planned_date: $pms_planned_date }
            })
            .done(function( res ) {
                $res1 = JSON.parse(res); 
                if($res1.status == true){
    ...
    function loadFormdata(){
        ...
        $.ajax({
            method: "POST",
            url: "../rber_condemned/function.php",
            data: { fn: "loadFormdata", rber_info_id: $rber_info_id }
        })
        .done(function( res ) {
            //console.log(res);
            $res1 = JSON.parse(res);
            if($res1.status == true){
                ...
                getAllProductImages($rber_info_id);
    ...
    function uploadajax(ttl,cl){
        ...
        form_data.append("rber_info_id", $rber_info_id);

        var request = $.ajax({
            url: "../rber_condemned/upload.php",
            cache: false,
            contentType: false,
            processData: false,
            async: true,
    ...
    function getAllProductImages(pmsinfoid){
        ...
        $.ajax({
            method: "POST",
            url: "../rber_condemned/function.php",
            data: { fn: "getAllProductImages", rber_info_id: pmsinfoid }
        })
        .done(function( res ) {
            $res1 = JSON.parse(res);
    ...
    function deleteProdImage($prod_iamge_name){
        ...
        if (confirm('Are you sure to delete the Image?')) {
            ...
            $.ajax({
                method: "POST",
                url: "../rber_condemned/function.php",
                data: { fn: "deleteProdImage", rber_info_id: $rber_info_id, prod_iamge_name: $prod_iamge_name }
            })
            .done(function( res ) {
                //console.log(res);
                $res1 = JSON.parse(res);
