...
function populateDataTable(){
    ...
    $('#example').DataTable({ 
        ...
        responsive: true,
        serverMethod: 'GET',
        ajax: {'url': 'rber_condemned/function.php?fn=getTableData' },
        dom: 'Bfrtip',
        buttons: [
            {
                extend:    'copyHtml5',
...
function populateDataTable_1(){
    ...
    $('#example_1').DataTable({ 
        responsive: true,
        serverMethod: 'GET',
        ajax: {'url': 'rber_condemned/function.php?fn=getTableData_1&facility_id='+$facility_id+'&facility_code='+$facility_code+'&device_group='+$device_group+'&asset_class='+$asset_class+'&department_id='+$department_id+'&equipment_name='+$equipment_name+'&asset_code='+$asset_code+'&from_date='+$from_date+'&to_date='+$to_date },
        dom: 'Bfrtip',
        buttons: [
            {
                extend:    'copyHtml5',
...
$('#generateLink').on('click', function(){ 
    ...
    .done(function( res ) {
        $res1 = JSON.parse(res);
        if($res1.status == true){
            window.open('rber_condemned/pms_link.php?rber_info_id='+$res1.rber_info_id, '_blank');
        }else{
