		...
		<div class="navbar-wrapper">
			<div class="navbar-content scroll-div" id="nav_bar">
				...
				<ul class="nav pcoded-inner-navbar " >
					...
					<li class="nav-item pcoded-hasmenu <?php if($p == 'user-details' || $p == 'facility' || $p == 'asset' || $p == 'department' || $p == 'device-group'){ ?> active pcoded-trigger <?php } ?>">
						...
						<ul class="pcoded-submenu">								
							...
							<li <?php if($p == 'device-group'){ ?> class="active" <?php } ?>><a href="?p=device-group&gr=setup">Device Group</a></li>							
