<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        <div class="m-header">
            ...
            <a href="?p=dashboard" class="b-brand">
                ...
                <img src="assets/images/logo_long_admin.png" alt="" class="logo" style="height: 45px;">
                    ...
                    <div class="dropdown mega-menu">
                        ...
                        <div class="dropdown-menu profile-notification ">
                            <div class="row no-gutters">
                                <div class="col">
                                    <h6 class="mega-title">Savings</h6>
                                    <ul class="pro-body">
                                ...
                                <div class="col">
                                    <h6 class="mega-title">Accounts</h6>
                                    <ul class="pro-body">
                                ...
                                <div class="col">
                                    <h6 class="mega-title">Reports</h6>
                                    <ul class="pro-body">
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="assets/images/user/avatar-5.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                            <p><strong>Rajib Dam</strong><span class="n-time text-muted"><i class="icon feather icon-clock m-r-10"></i>5 min</span></p>
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                <a href="?p=signin&log=out&id=<?=base64_encode($_SESSION["user_id"])?>" class="dud-logout" title="Logout">
