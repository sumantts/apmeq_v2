...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="Calibration Soft Link">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-1">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="calib_id" id="calib_id" value="">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 mb-1">
                                <div class="form-group">
                                    <label for="pms_planned_date">Calibration planned date</label>
