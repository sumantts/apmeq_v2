            ...
            <div class="col-md-12 col-xl-12">
                <div class="card support-bar overflow-hidden">
                    <div class="card-body pb-0 text-center">
                        <h2 class="m-0">350</h2>
                        <span class="text-c-blue">QA Status</span>
                    ...
                    <div class="card-footer bg-primary text-white">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                ...
                                <span>Total QA Schedule / planned</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5>Facility wise QA Tickets</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate>
                            <div class="form-row">                               
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="author_name">QA Status</label>
                                    <select class="form-control" id="author_name">
                                        <option value="0">Select</option>
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="author_name">QA Required</label>
                                    <select class="form-control" id="author_name">
                                        <option value="0">Select</option>
