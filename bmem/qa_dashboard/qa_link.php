...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="QA Soft Link">
  ...
  <body>
        ...
        <div class="contact__wrapper shadow-lg mt-n9">
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 contact-form__wrapper p-5 order-lg-1">
                    <h4 class="text-center">QA Info #<?=$_GET['qa_info_id']?></h4>
                    <form action="#" method="POST" class="contact-form form-validate" id="myForm">
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-1">
                                <div class="form-group">
                                    <label for="pms_due_date">QA due date</label>
    ...
    function loadFormdata(){
        ...
        $.ajax({
            method: "POST",
            url: "../qa_dashboard/function.php",
            data: { fn: "loadFormdata", qa_info_id: $qa_info_id }
        })
        .done(function( res ) {
            //console.log(res);
            $res1 = JSON.parse(res);
    ...
    function uploadajax(ttl,cl){
        ...
        form_data.append("qa_info_id", $qa_info_id);

        var request = $.ajax({
            url: "../qa_dashboard/upload.php",
            cache: false,
            contentType: false,
            processData: false,
            async: true,
    ...
    function getAllProductImages(pmsinfoid){
        ...
        $.ajax({
            method: "POST",
            url: "../qa_dashboard/function.php",
            data: { fn: "getAllProductImages", qa_info_id: pmsinfoid }
        })
        .done(function( res ) {
            $res1 = JSON.parse(res);
    ...
    function deleteProdImage($prod_iamge_name){
        ...
        if (confirm('Are you sure to delete the Image?')) {
            ...
            $.ajax({
                method: "POST",
                url: "../qa_dashboard/function.php",
                data: { fn: "deleteProdImage", qa_info_id: $qa_info_id, prod_iamge_name: $prod_iamge_name }
            })
            .done(function( res ) {
                //console.log(res);
                $res1 = JSON.parse(res);
