...
function populateDataTable(){
    ...
    $('#example').DataTable({ 
        ...
        responsive: true,
        serverMethod: 'GET',
        ajax: {'url': 'qa_dashboard/function.php?fn=getTableData' },
        dom: 'Bfrtip',
        buttons: [
            {
                extend:    'copyHtml5',
...
function populateDataTable_1(){
    ...
    $('#example_1').DataTable({ 
        responsive: true,
        serverMethod: 'GET',
        ajax: {'url': 'qa_dashboard/function.php?fn=getTableData_1&facility_id='+$facility_id+'&facility_code='+$facility_code+'&device_group='+$device_group+'&asset_class='+$asset_class+'&department_id='+$department_id+'&PMSStatus='+$PMSStatus+'&PMSRequired='+$PMSRequired+'&from_date='+$from_date+'&to_date='+$to_date },
        dom: 'Bfrtip',
        buttons: [
            {
                extend:    'copyHtml5',
